use codex_code_mode_types::ImageDetail as CodeModeImageDetail;
...
pub(super) fn into_function_call_output_content_items(
    items: Vec<codex_code_mode_types::FunctionCallOutputContentItem>,
...
impl IntoProtocol<FunctionCallOutputContentItem>
    for codex_code_mode_types::FunctionCallOutputContentItem
{
    fn into_protocol(self) -> FunctionCallOutputContentItem {
        let value = self;
        match value {
            codex_code_mode_types::FunctionCallOutputContentItem::InputText { text } => {
                FunctionCallOutputContentItem::InputText { text }
            }
            codex_code_mode_types::FunctionCallOutputContentItem::InputImage {
                image_url,
                detail,
            ...
            codex_code_mode_types::FunctionCallOutputContentItem::InputAudio { audio_url } => {
