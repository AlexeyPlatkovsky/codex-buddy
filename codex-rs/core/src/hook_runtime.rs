...
#[cfg(all(feature = "plugins", feature = "connectors"))]
...
#[cfg(not(all(feature = "plugins", feature = "connectors")))]
fn executor_hook_sources_for_step(_step_context: &StepContext) -> Vec<ExecutorPluginHookSource> {
    Vec::new()
}
