...
use crate::plugins::runtime::ResolvedPluginMetricsOperation;
use crate::plugins::runtime::TrustedPluginRoots;
...
impl Session {
    ...
    async fn new_turn_context_from_configuration(
        ...
        if !self.hooks().matches_plugin_hooks(
            plugin_outcome.effective_plugin_hook_sources().iter(),
            plugin_outcome.effective_plugin_hook_warnings().iter(),
        ) {
