...
use crate::audio_input::prepare_response_items as prepare_audio_response_items;
use crate::compact;
...
pub(crate) struct SessionSpawnArgs {
    ...
    pub(crate) code_mode_session_provider: Arc<dyn codex_code_mode_types::CodeModeSessionProvider>,
